...
function Calendar(props) {
    ...
    useEffect(() => {
        setDays([
            <Day blocks={blocksGrid[0]}/>,
            <Day blocks={blocksGrid[1]}/>,
            <Day blocks={blocksGrid[2]}/>,
            <Day blocks={blocksGrid[3]}/>,
            <Day blocks={blocksGrid[4]}/>,
            <Day blocks={blocksGrid[5]}/>,
            <Day blocks={blocksGrid[6]}/>]);
    }, [blocksGrid]);
