...
public class TriggerActionExecutor {
  private Map<String, edu.brown.cs.madhavramesh.stars.TriggerAction> actions = new HashMap<>();
   ...
   *            be executed
   */
  public TriggerActionExecutor(List<edu.brown.cs.madhavramesh.stars.TriggerAction> tas) {
    for (edu.brown.cs.madhavramesh.stars.TriggerAction ta : tas) {
  ...
  public String executeTriggerAction(String command, String[] args, boolean isREPL)
    ...
    String result = "";
    edu.brown.cs.madhavramesh.stars.TriggerAction correctAction = actions.get(command);
